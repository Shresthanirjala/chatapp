...
const SignUp = () => {
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
      <div className='w-full p-6 ronded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
        ...
        <form action="">
          ...
          <div>
                ...
                <label className='label p-2'>
                    ...
                    <input type="password" placeholder="enter confirm password" className='w-full input input-borderes h-10' />
                </div>
      {/*  */}
<GenderCheckbox/>
